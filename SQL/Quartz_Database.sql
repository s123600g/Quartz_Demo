...
CREATE TABLE qrtz_job_details
  (
    ...
    IS_DURABLE VARCHAR2(20) NOT NULL,
    IS_NONCONCURRENT VARCHAR2(20) NOT NULL,
    IS_UPDATE_DATA VARCHAR2(20) NOT NULL,
    REQUESTS_RECOVERY VARCHAR2(20) NOT NULL,
    JOB_DATA BLOB NULL,
...
CREATE TABLE qrtz_fired_triggers 
  (
    ...
    IS_NONCONCURRENT VARCHAR2(20) NULL,
    REQUESTS_RECOVERY VARCHAR2(20) NULL,
